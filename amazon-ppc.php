            ...
            <div class="list-box" data-aos="fade-up" data-aos-duration="1000">
               <ul>
                  <li>
                     ...
                     <h2>Amazon FBA setup & management</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
         ...
         <div class="col-md-6 myserviesabt">
            ...
            <div class="list-box-servi-abt" data-aos="fade-up" data-aos-duration="1000">
               <ul>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>Increased buyer traffic</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>Easy sales and conversions</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>Relevant product visibility</h2>
                  </li>
               </ul>
               <ul>
                  <li>
                  ...
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>Categorical listing</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>Keyword research and relevancy</h2>
                  </li>
               </ul>
            </div>
            <div class="bnr-btn" data-aos="fade-up" data-aos-duration="1000">
         ...
         <div class="col-md-6 myserviesabt2">
            ...
            <div class="list-box-servi-abt2" data-aos="fade-up" data-aos-duration="1000">
               <ul>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>for a unique brand presence</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>to uptick organic Amazon rankings</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>for Amazon store scheduling</h2>
                  </li>
               </ul>
               <ul>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>for a smooth shopping experience</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>for shoppable images</h2>
                  </li>
                  <li>
                     <i class="fa fa-chevron-right" aria-hidden="true"></i>
                     <h2>for a mini brand website</h2>
                  </li>
               </ul>
            </div>
...
<section class="casestudy">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 casestudy-bg">
                <div class="row">
                ...
                <div class="chose-box" data-aos="fade-up" data-aos-duration="1000">
                    <div class="row">
                        <div class="col-sm-9 why-chose-box">
                            <div class="icon-box">
                                <img class="normal" src="assests/images/why-chose-ico.png" alt="">
                                <img class="hover" src="assests/images/whychoose-hover.png" alt="">
                                <h2>Expert Guidance</h2>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s Lorem Ipsum is simply dummy text of the printing and typesetting </p>
                            </div>
                        </div>
                        <div class="col-sm-3 choose-bg">
                            <div class="why-chose-num">
                                <h1>01</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-9 why-chose-box">
                            <div class="icon-box">
                                <img class="normal" src="assests/images/why-chose-ico.png" alt="">
                                <img class="hover" src="assests/images/whychoose-hover.png" alt="">
                                <h2>Complete Store Development</h2>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s Lorem Ipsum is simply dummy text of the printing and typesetting </p>
                            </div>
                        </div>
                        <div class="col-sm-3 choose-bg">
