...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../assests/css/fancybox.min.css">      
    </head>
  <body>
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li>
                              ...
                              <ul class="submenu dropdown-menu">
                                 ...
                                 <li><a class="dropdown-item" href="#">Profitability Analysis</a></li>
                           ...
                           <li>
                              ...
                              <ul class="submenu dropdown-menu">
                                 ...
                                 <li><a class="dropdown-item" href="#">Brand Registration</a></li>
